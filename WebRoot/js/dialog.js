...
function dialog(title,content,width,height,cssName,topSpace,showbg,offsets,obj){
...
if(offsets == null && obj == null)
{
	...
	$("#floatBox").animate({top:($(document).scrollTop()+$(window).height()/2-parseInt(topSpace))+"px"},"100");
}
